...
if spoon.WinWin then
    ...
    cmodal:bind('', 'U', 'thirdleft', function() spoon.WinWin:stash() spoon.WinWin:moveAndResize("thirdleft") end)
    cmodal:bind('', 'I', 'thirdmiddle', function() spoon.WinWin:stash() spoon.WinWin:moveAndResize("thirdmiddle") end)
    cmodal:bind('', 'O', 'thirdright', function() spoon.WinWin:stash() spoon.WinWin:moveAndResize("thirdright") end)
    ...
    cmodal:bind('cmd', 'H', 'Move to Left Monitor', function() spoon.WinWin:stash() spoon.WinWin:moveToScreen("left") end)
    cmodal:bind('cmd', 'L', 'Move to Right Monitor', function() spoon.WinWin:stash() spoon.WinWin:moveToScreen("right") end)
    cmodal:bind('cmd', 'K', 'Move to Full', function() spoon.WinWin:stash() spoon.WinWin:moveAndResize("realfull") end)
    cmodal:bind('cmd', 'J', 'Move to Center', function() spoon.WinWin:stash() spoon.WinWin:moveAndResize("realSmall") end)
    cmodal:bind('', 'space', 'Move to Next Monitor', function() spoon.WinWin:stash() spoon.WinWin:moveAndResize("next") end)
